...
1. Click on the **"Puzzle"** icon 🧩 in the top right corner of the browser.
   ...
   <img width="122" height="49" alt="Browser extension management icon" src="https://github.com/user-attachments/assets/de92210c-1a98-4e5b-9cf5-abf12a5983f2" />

2. Find **YFull Finder** and click the **"Pin"** button.

   <img width="303" height="140" alt="Pinning YFull Finder extension" src="https://github.com/user-attachments/assets/1c3bc732-b513-4117-930e-470e8f9c4138" />

3. Click on the extension icon.

   <img width="429" height="489" alt="YFull Finder main window" src="https://github.com/user-attachments/assets/2ba8cd44-5523-4c47-8bf2-7aab3d3d376e" />

4. In the opened window, go to the **Register** or **Login** tab.

   <img width="421" height="667" alt="YFull Finder registration and login form" src="https://github.com/user-attachments/assets/a3de975f-8924-4712-90b5-6bc13d305cf8" />
...
<img width="678" height="636" alt="Example of enriched YFull tree with surnames and flags" src="https://github.com/user-attachments/assets/ea74875c-ddf3-4299-a24d-20f06b2c15f0" />
...
1. Find a sample with a gray **[+]** icon (this means there's no data yet).
   ...
   <img width="631" height="167" alt="Sample without data with add button" src="https://github.com/user-attachments/assets/6a8bd265-0906-44ba-86ad-42ae6e6d8246" />

2. Click on **[+]**. You'll be redirected to the data entry form.
...
4. Fill in the fields:
   ...
   <img width="1351" height="538" alt="Genealogical data entry form" src="https://github.com/user-attachments/assets/c3c7fe6a-b9c0-466b-9e8b-879d92b96661" />

5. Click on **"Additional Information"** to specify extended data (village, historical region, additional info).
...
Manage your contributions through the web portal [**yfinder.vercel.app**](https://yfinder.vercel.app):
...
3. Try opening the portal directly: [yfinder.vercel.app](https://yfinder.vercel.app)
...
**A:** 
1. Log in to the [web portal](https://yfinder.vercel.app).
...
**A:** Contact administration via [Telegram](https://t.me/abkhazdna) with a deletion request. We'll process the request within 48 hours.
</details>
...
| Data doesn't save | Make sure you're logged in. Check that all required fields are filled. |
| Flags don't display | Update extension to latest version (1.1.5+). |
...
- 🌐 **Web Portal:** [yfinder.vercel.app](https://yfinder.vercel.app)
